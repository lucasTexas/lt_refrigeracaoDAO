...
<body>
    ...
    <article id="main-content">
        <div class="container">
            <h1 class="mb-4">Alterar Ganho</h1>
            <form name="alterar_ganho" method="POST" action="/lt_refrigeracaoDAO/controller/ganhosUpdateController.php">
                ...
                <button type="submit" class="btn btn-primary">Alterar Ganho</button>
            </form>
        </div>
    </article>
