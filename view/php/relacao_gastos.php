...
<body>
    ...
    <article id="main-content">
        <div class="container">
            <h1 class="mb-4">Relação de Gastos</h1>
                    ...
                    <tbody>
                        ...
                        foreach ($listaGastos as $gasto) {
                            echo "<tr>
                                ...
                                <td>
                                    <form method='POST' action='/lt_refrigeracaoDAO/controller/gastosDeleteController.php' class='d-inline'>
                                        <input type='hidden' name='id' value='" . $gasto->getIdGastos() . "'>
                                        <button type='submit' class='btn btn-danger btn-sm btn-action'>Deletar</button>
                                    </form>
                                    <form method='POST' action='/lt_refrigeracaoDAO/view/php/alterar_gasto.php' class='d-inline'>
                                        <input type='hidden' name='id' value='" . $gasto->getIdGastos() . "'>
